...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    right_hand.scale.x = left_hand.scale.x = 0.14f;
    right_hand.scale.y = left_hand.scale.y = 0.14f;
    right_hand.scale.z = left_hand.scale.z = 0.14f;


    // Set the color -- be sure to set alpha to something non-zero!
    right_hand.color.r = left_hand.color.r = 1.0f;
    right_hand.color.a = left_hand.color.a = 0.7f;
